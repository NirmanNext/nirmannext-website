...
const About = () => {
  const milestones = [
    { year: "2019", title: "Company Founded", description: "Started with a vision to digitize construction materials supply" },
    { year: "2020", title: "First 100 Partners", description: "Built initial network of contractors and suppliers" },
    { year: "2021", title: "Private Label Launch", description: "Introduced PlasterKing and RockGrip brands" },
  ...
  const team = [
    {
      ...
      background: "Former VP at leading cement manufacturer",
    ...
    },
    {
      ...
      background: "Ex-Amazon logistics head",
      focus: "Operations excellence and delivery network"
    },
    {
      name: "Amit Patel",
      role: "CTO",
      experience: "10+ years in tech",
      background: "Former lead engineer at Flipkart",
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-4xl mx-auto">
            {[
              { number: "50,000+", label: "Projects Completed", description: "Construction projects powered by our materials" },
              { number: "2,500+", label: "Partner Network", description: "Contractors, retailers, and suppliers" },
              { number: "15", label: "States Covered", description: "Pan-India presence and growing" },
              { number: "99.2%", label: "Customer Satisfaction", description: "Based on verified customer reviews" }
            ].map((stat) => (
