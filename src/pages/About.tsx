  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-6">
              Building a <span className="text-construction-orange">Better Tomorrow</span>, Together
            </h1>
      ...
      <section className="py-16 bg-accent/5">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">Our Core <span className="text-construction-orange">Values</span></h2>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">Our <span className="text-construction-orange">Impact</span></h2>
            <p className="text-muted-foreground">
      ...
      <section className="py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Join Us in <span className="text-construction-orange">Building</span> India's Future</h2>
